...
<?php
    ...
    $registros=mysql_query("Select * from usuario where mail='$idUsuario'", $conexion) 
                ...
                <div class="col-xs-6 col-md-8">
                    <form action="modificarPass.php" method="post" data-toggle="validator" class="form-horizontal"  id="ormularioAltaUsuario" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="hidden" class="form-control" id="actual" name="actual"  placeholder="De 6 a 15 caracteres" required pattern="[\s\S]{6,15}" value="<?php echo $usuario['pass']?>" >
                            </div>
                        </div>
                        <div class="form-group">
