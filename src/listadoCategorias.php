<div class="list-group">
    ...
    <?php
          ...
          while($categoria=mysql_fetch_array($cat)){
            ?>
            <a href="#" class="list-group-item" onclick="window.location.href='porCategoria.php?categorial=<?php echo $categoria['id'];?>'"><span class="badge"><?php echo $categoria['cantidad']; ?> </span><?php echo $categoria['nombre']; ?> </a><?php        
          } 
    ?>       
</div>