<div class="list-group">
                      ...
                      <a href="#" class="list-group-item "  onclick="mostrarResultados('publicacionesActivas.php'); " ><span class="badge"></span>- Publicaciones Activas</a>
                      <a href="#" class="list-group-item "  onclick="mostrarResultados('publicacionesFinalizadas.php'); " ><span class="badge"></span>- Publicaciones Finalizadas</a>
                      <a href="#" class="list-group-item "  onclick="mostrarResultados('publicacionesEliminadas.php'); " ><span class="badge"></span>- Publicaciones Eliminadas</a>
                  
                      <a href="#" class="list-group-item " ><span class="badge"></span><strong>Mis Preguntas</strong></a>
