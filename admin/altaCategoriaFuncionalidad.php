...
$verificaCategoria=mysql_query(" SELECT count(nombre) as cantidad from categoria where nombre='$nombreCategoria' and baja='false' ",$conexion) or die("Problemas en el select:".mysql_error());
...
header("location: altaCategoriaVisualizacion.php?c=1 ");
}
?>
