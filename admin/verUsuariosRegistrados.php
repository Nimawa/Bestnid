	            	...
	            	<div class="row">
						<form method="POST" data-toggle="validator" class="form-horizontal"  id="buscarUsuarios" >
	                        <div class="form-group col-lg-4 ">
	                            ...
	                            <div class="col-lg-7">
                  				<input type="text" class="form-control" required id="fecha1" name="fecha1" value="2015-01-01" >
	                        ...
	                        <div class="form-group col-lg-4 ">
	                            ...
	                            <div class="col-lg-7">
                  				<input type="text" class="form-control" required id="fecha2" name="fecha2" value="<?php echo date("Y-m-d")?>">
	                              <div class="help-block with-errors"></div>   
	                            </div>
	                        </div>
