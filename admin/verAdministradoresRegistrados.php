        ...
        <div class="container-fluid">
            <div class="row">
	            ...
	            <div id="resulta" class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
	            	<div  class="row">
	                    <h3>
	                        <strong style=""> Administradores Registrados  </strong> 
	            	...
	            	<div class="row">
						<form method="POST" data-toggle="validator" class="form-horizontal"  id="buscarUsuarios" >
	                        ...
	                        <div class="form-group  col-lg-2" >
	                            <div >
	                              <input type="button" class="btn btn-danger col-lg-12  btn-sm" style=" margin-left: 20px;" value="Buscar" onclick="usuariosRegistrados('listadoAdministradoresRegistrados.php')">
	                            </div>
	                        </div>    
	                   	</form> 
	                </div>
